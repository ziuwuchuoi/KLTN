...
import { AVATAR_PLACEHOLDER } from "@/assets";
...
export function ProfileHeader({ user, userType, updateAvatar }: ProfileHeaderProps) {
        ...
        <div className="flex flex-col items-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-8">
            <div className="relative group">
                <Avatar className="h-32 w-32 border-4 border-gray-800">
                    <AvatarImage src={user?.avatar || AVATAR_PLACEHOLDER} alt={user?.name} />
