            ...
            <div className="flex-1 p-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-8">
                        <div className="bg-green-600/20 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                            <Trophy className="h-10 w-10 text-green-400" />
                        </div>
                        <CustomHeroSection
                            title="Assessment"
                            subtitle="Completed!"
                            description="Thank you for completing the technical assessment. Your results have been submitted successfully."
                            align="center"
                            compact={true}
                        />
                    </div>
                        ...
                        <Card className="bg-slate-800/50 border-slate-700">
                            ...
                            <CardContent>
                                <div className="text-center">
                                    <div className={`text-3xl font-bold mb-2 ${getScoreColor(finalScore)}`}>
                                        {finalScore}%
                                    </div>
                    ...
                    <Card className="bg-slate-800/50 border-slate-700">
                        ...
                        <CardContent className="space-y-4">
                            <p className="text-gray-300">
                                Your assessment has been submitted and will be reviewed by our team. Here's what happens
                                next:
                            </p>
